...
class Kubernetes(object):
    ...
    def create_jobset(
        ...
        for k, v in {
            ...
            job.environment_variable_from_selector(k, v)
        ...
        job.environment_variable("MF_MASTER_ADDR", job.jobset_control_addr)
        job.environment_variable("MF_MASTER_PORT", str(port))
        job.environment_variable("MF_WORLD_SIZE", str(num_parallel))
        job.environment_variable_from_selector(
        ...
        job.control.environment_variable("UBF_CONTEXT", UBF_CONTROL)
        job.worker.environment_variable("UBF_CONTEXT", UBF_TASK)
        ...
        job.control.environment_variable("MF_CONTROL_INDEX", "0")
